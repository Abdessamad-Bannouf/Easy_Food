  ...
  <html>
        ...
        <body>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <form method="POST" action="http://localhost/easy_food/administrateur/modifier" role="form" enctype="multipart/form-data">
                        ...
                        <button name="envoyer" type="submit" id="loginSubmit" class="btn btn-success loginFormElement">Modifier produit</button>
